...
public class HttpController {
    ...
    @ApiOperation(value = "View a list of all Marvel characters Ids", response = Iterable.class)
    @ApiResponses(value = {
    ...
    @ApiOperation(value = "Search a Marvel character with ID", response = MarvelCharacter.class)
    @RequestMapping(value = "/characters/{id}", method= RequestMethod.GET, produces = "application/json")
    public MarvelCharacter showCharacter(@PathVariable Integer id, Model model){
        return marvelCharacterService.getCharacterById(id);
    }
}
